    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            -webkit-backdrop-filter: blur(10px);
            border-left: 1px solid var(--glass-border);
            padding: 6rem 1rem 1rem 1rem; /* Added top padding to account for navbar */
            z-index: 999;
            overflow-y: auto;
        }
...
<body>
        ...
        <div class="status-list">
            <div class="student-status">
                ...
                <div class="student-info">
                    <div class="student-name">Ahmad Rizki</div>
                    <div class="student-class">Kelas X IPA 1</div>
                </div>
            </div>
            <div class="student-status">
                <div class="status-indicator online"></div>
                <div class="student-info">
                    <div class="student-name">Sarah Putri</div>
                    <div class="student-class">Kelas XI IPS 2</div>
                </div>
            </div>
            <div class="student-status">
                ...
                <div class="student-info">
                    ...
                    <div class="student-class">Kelas XII IPA 3</div>
                </div>
            </div>
            <div class="student-status">
                <div class="status-indicator online"></div>
                <div class="student-info">
                    <div class="student-name">Putri Rahayu</div>
                    <div class="student-class">Kelas X IPS 1</div>
                </div>
            </div>
            <div class="student-status">
                <div class="status-indicator offline"></div>
                <div class="student-info">
                    ...
                    <div class="student-class">Kelas XI IPA 2</div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const toggleButton = document.querySelector('.status-toggle');
